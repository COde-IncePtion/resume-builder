...
const data = {
  ...
  aim:
    "To continue my career with an organisation that will utilize my TECHNICAL and INTELLECTUAL ability for bilateral growth.",
  technicalSkills: [
    "Java",
    "C++",
    "Python",
  ...
  workExperiences: [
    {
      ...
      location: "Pune, India",
      tasks: [
        "Worked on developing web app for a big UK firm which dealt with financial data and information providing.",
...
export default ResumeAreaLayout;
